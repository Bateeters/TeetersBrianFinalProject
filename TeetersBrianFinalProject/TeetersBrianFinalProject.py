import tkinter as tk  # Getting tkinter package
...
def getSelection(dropdown):
    ...
    # Aphrodite Page
    if selection == 'Aphrodite':  # If Aphrodite is selected in the menu
        ...
        # Photo above text
        image1 = Image.open("Greek Knowledge Finder/GreekGodBanners/Aphrodite.png")  # Sets photo to be used
    ...
    # Apollo Page (code serves same purpose as previous pages)
        ...
        image1 = Image.open("Greek Knowledge Finder/GreekGodBanners/Apollo.png")
    ...
    # Ares Page (code serves same purpose as previous pages)
        ...
        image1 = Image.open("Greek Knowledge Finder/GreekGodBanners/Ares.png")
        resized_image = image1.resize((125, 175), Image.ANTIALIAS)
        test = ImageTk.PhotoImage(resized_image)
    ...
    # Artemis Page (code serves same purpose as previous pages)
        ...
        image1 = Image.open("Greek Knowledge Finder/GreekGodBanners/Artemis.png")
        resized_image = image1.resize((125, 175), Image.ANTIALIAS)
        test = ImageTk.PhotoImage(resized_image)
    ...
    # Athena Page (code serves same purpose as previous pages)
        ...
        image1 = Image.open("Greek Knowledge Finder/GreekGodBanners/Athena.png")
        resized_image = image1.resize((125, 175), Image.ANTIALIAS)
        test = ImageTk.PhotoImage(resized_image)
    ...
    # Demeter Page (code serves same purpose as previous pages)
        ...
        image1 = Image.open("Greek Knowledge Finder/GreekGodBanners/Demeter.png")
        resized_image = image1.resize((125, 175), Image.ANTIALIAS)
        test = ImageTk.PhotoImage(resized_image)
    ...
    # Dionysus Page (code serves same purpose as previous pages)
        ...
        image1 = Image.open("Greek Knowledge Finder/GreekGodBanners/Dionysus.png")
        resized_image = image1.resize((125, 175), Image.ANTIALIAS)
        test = ImageTk.PhotoImage(resized_image)
    ...
    # Hades Page (code serves same purpose as previous pages)
        ...
        image1 = Image.open("Greek Knowledge Finder/GreekGodBanners/Hades.png")
        resized_image = image1.resize((125, 175), Image.ANTIALIAS)
        test = ImageTk.PhotoImage(resized_image)
    ...
    # Hephaestus Page (code serves same purpose as previous pages)
        ...
        image1 = Image.open("Greek Knowledge Finder/GreekGodBanners/Hephaestus.png")
        resized_image = image1.resize((125, 175), Image.ANTIALIAS)
        test = ImageTk.PhotoImage(resized_image)
    ...
    # Hera Page (code serves same purpose as previous pages)
        ...
        image1 = Image.open("Greek Knowledge Finder/GreekGodBanners/Hera.png")
        resized_image = image1.resize((125, 175), Image.ANTIALIAS)
        test = ImageTk.PhotoImage(resized_image)
    ...
    # Hermes Page (code serves same purpose as previous pages)
        ...
        image1 = Image.open("Greek Knowledge Finder/GreekGodBanners/Hermes.png")
        resized_image = image1.resize((125, 175), Image.ANTIALIAS)
        test = ImageTk.PhotoImage(resized_image)
    ...
    # Poseidon Page (code serves same purpose as previous pages)
        ...
        image1 = Image.open("Greek Knowledge Finder/GreekGodBanners/Poseidon.png")
        resized_image = image1.resize((125, 175), Image.ANTIALIAS)
        test = ImageTk.PhotoImage(resized_image)
    ...
    # Zeus Page (code serves same purpose as previous pages)
        ...
        image1 = Image.open("Greek Knowledge Finder/GreekGodBanners/Zeus.png")
        resized_image = image1.resize((125, 175), Image.ANTIALIAS)
        test = ImageTk.PhotoImage(resized_image)
...
# main page photo
photo = tk.PhotoImage(file="Greek Knowledge Finder/building1.png")  # Sets photo for home page
